...
public final class ActivityTimerBinding implements ViewBinding {
  ...
  private ActivityTimerBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnReset,
      @NonNull Button btnStart, @NonNull Button btnStop, @NonNull ConstraintLayout main,
  ...
  public static ActivityTimerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityTimerBinding((ConstraintLayout) rootView, btnReset, btnStart, btnStop,
          main, tvTimer);
    }
